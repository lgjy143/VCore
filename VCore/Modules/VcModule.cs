...
namespace VCore.Modules
{
    public class VcModule
    {
        ...
        public static bool IsVcModule(Type type)
        {
            ...
            return
                ...
                typeof(VcModule).IsAssignableFrom(type);
        }
        ...
        public static List<Type> FindDependedModuleTypesRecursivelyIncludingGivenModule(Type moduleType)
        {
            ...
            list.AddIfNotContains(typeof(VcKernelModule));
            return list;
        }

        private static void AddModuleAndDependenciesRecursively(List<Type> modules, Type module)
        {
            if (!IsVcModule(module))
            {
                throw new VcInitializationException("This type is not an VC module: " + module.AssemblyQualifiedName);
            }
