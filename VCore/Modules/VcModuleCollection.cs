...
{
    public class VcModuleCollection : List<VcModuleInfo>
    {
        public Type StartupModuleType { get; }

        public VcModuleCollection(Type startupModuleType)
        {
        ...
        public TModule GetModule<TModule>() where TModule : VcModule
        {
            var module = this.FirstOrDefault(m => m.Type == typeof(TModule));
            if (module == null)
            {
                throw new VcException("Can not find module for " + typeof(TModule).FullName);
            }
        ...
        public List<VcModuleInfo> GetSortedModuleListByDependency()
        {
        ...
        public static void EnsureKernelModuleToBeFirst(List<VcModuleInfo> modules)
        {
            var kernelModuleIndex = modules.FindIndex(m => m.Type == typeof(VcKernelModule));
        ...
        public static void EnsureStartupModuleToBeLast(List<VcModuleInfo> modules, Type startupModuleType)
        {
